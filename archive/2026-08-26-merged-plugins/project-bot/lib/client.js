window.__ModuleLoader__.load({
	id: "@dsh-agent-toolkit/project-bot",
	factory: (require) => {
		var module = { exports: {} };
		...
		const fetchBots = () => request("/project-bot/api/bots").then((r) => r.bots);
		const fetchProviders = () => request("/project-bot/api/providers").then((r) => r.providers);
		const fetchPresets = () => request("/project-bot/api/presets").then((r) => r.presets);
		const fetchModels = (provider) => request(`/project-bot/api/models?provider=${encodeURIComponent(provider)}`).then((r) => r.models);
		function createBot(input) {
			return request("/project-bot/api/bots", {
				method: "POST",
				body: JSON.stringify(input)
			});
		}
		function updateBot(id, input) {
			return request(`/project-bot/api/bots?id=${encodeURIComponent(id)}`, {
				method: "PUT",
				body: JSON.stringify(input)
			});
		}
		const startRegisterApp = () => request("/project-bot/api/register-app", { method: "POST" });
		const pollRegisterApp = (id) => request(`/project-bot/api/register-app/status?id=${encodeURIComponent(id)}`).then((r) => r.state);
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:D:\work\github\dsh\dsh-agent-toolkit\packages\project-bot\src\client\bots.module.css.mjs
		...
		const css = ".GsWMKW_trigger{box-sizing:border-box;cursor:pointer;width:auto;height:42px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:12px;flex:none;align-items:center;gap:8px;margin:4px 0;padding:0 10px 0 8px;font-family:inherit;font-size:14px;line-height:22px;display:flex;overflow:hidden}.GsWMKW_trigger:hover{background:var(--dsw-alias-interactive-bg-hover)}.GsWMKW_trigger.GsWMKW_rail{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;margin:8px 0 10px;padding:0}.GsWMKW_triggerLabel{white-space:nowrap;font-size:13px;overflow:hidden}.GsWMKW_dialog{width:560px}.GsWMKW_group{margin-bottom:12px}.GsWMKW_groupTitle{opacity:.6;word-break:break-all;margin:0 0 4px;font-size:12px}.GsWMKW_botRow{border:1px solid var(--dsw-alias-border-l2);cursor:pointer;width:100%;font:inherit;color:inherit;text-align:left;background:0 0;border-radius:6px;align-items:center;gap:8px;margin-bottom:4px;padding:8px 10px;display:flex}.GsWMKW_botRow:hover{background:var(--dsw-alias-interactive-bg-hover)}.GsWMKW_botName{text-overflow:ellipsis;white-space:nowrap;flex:1;min-width:0;overflow:hidden}.GsWMKW_channelBadge{flex:none}.GsWMKW_status{color:var(--dsw-alias-label-tertiary);flex:none;align-items:center;gap:6px;font-size:12px;line-height:18px;display:inline-flex}.GsWMKW_createButton{margin-top:8px}.GsWMKW_field{color:var(--dsw-alias-label-secondary);flex-direction:column;gap:6px;margin:0 0 12px;font-size:13px;line-height:20px;display:flex}.GsWMKW_input{box-sizing:border-box;width:100%}.GsWMKW_select,.GsWMKW_textarea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;color:var(--dsw-alias-label-primary);font:inherit;border-radius:12px;font-size:14px;line-height:22px}.GsWMKW_select{height:32px;padding:0 8px}.GsWMKW_textarea{resize:vertical;padding:4px 8px}.GsWMKW_select:focus,.GsWMKW_textarea:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.GsWMKW_steps{color:var(--dsw-alias-label-tertiary);align-items:center;gap:6px;margin:0 0 16px;font-size:13px;line-height:20px;display:flex}.GsWMKW_step{color:var(--dsw-alias-label-tertiary)}.GsWMKW_stepActive{color:var(--dsw-alias-label-primary);font-weight:600}.GsWMKW_stepSeparator{color:var(--dsw-alias-label-tertiary)}.GsWMKW_tabs{background:var(--dsw-alias-bg-layer-2);border-radius:12px;gap:2px;margin-bottom:12px;padding:3px;display:inline-flex}.GsWMKW_tab{height:28px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:9px;padding:0 12px;font-size:13px;line-height:28px}.GsWMKW_tabActive{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.GsWMKW_scanSection{margin:0 0 12px}.GsWMKW_error{color:var(--dsw-alias-state-error-primary);margin:0 0 12px;font-size:12px;line-height:18px}.GsWMKW_formActions{justify-content:flex-end;gap:8px;margin-top:4px;display:flex}";
		const tagId = "@dsh-agent-toolkit/project-bot/bots.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@dsh-agent-toolkit/project-bot";
		...
		var bots_module_css_default = {
			...
			"tabs": "GsWMKW_tabs",
			"tab": "GsWMKW_tab",
			"stepActive": "GsWMKW_stepActive",
			"botName": "GsWMKW_botName",
			"triggerLabel": "GsWMKW_triggerLabel",
			"scanSection": "GsWMKW_scanSection",
			"error": "GsWMKW_error",
			"formActions": "GsWMKW_formActions",
			"stepSeparator": "GsWMKW_stepSeparator",
			"tabActive": "GsWMKW_tabActive",
			"createButton": "GsWMKW_createButton",
			"channelBadge": "GsWMKW_channelBadge",
			"trigger": "GsWMKW_trigger",
			"botRow": "GsWMKW_botRow",
			"steps": "GsWMKW_steps",
			"groupTitle": "GsWMKW_groupTitle",
			"input": "GsWMKW_input",
			"rail": "GsWMKW_rail",
			"select": "GsWMKW_select",
			"textarea": "GsWMKW_textarea",
			"dialog": "GsWMKW_dialog",
			"status": "GsWMKW_status",
			"field": "GsWMKW_field"
		};
		//#endregion
		//#region src/client/BotForm.tsx
		/** 机器人创建/编辑表单：两步向导——基本信息 → 飞书渠道绑定。 */
		const POLL_INTERVAL_MS = 200;
		function BotForm({ bot, useWorkspaces, onSaved, onCancel }) {
			const workspaces = useWorkspaces((s) => s.items);
			const editing = bot !== void 0;
			const [step, setStep] = (0, react.useState)(1);
			const [name, setName] = (0, react.useState)(bot?.name ?? "");
			const [project, setProject] = (0, react.useState)(bot?.project ?? workspaces[0]?.path ?? "");
			const [persona, setPersona] = (0, react.useState)(bot?.persona ?? "");
			const [preset, setPreset] = (0, react.useState)(bot?.preset ?? "");
			const [presets, setPresets] = (0, react.useState)([]);
			const [provider, setProvider] = (0, react.useState)(bot?.agentOptions?.provider ?? "");
			const [model, setModel] = (0, react.useState)(bot?.agentOptions?.model ?? "");
			...
			(0, react.useEffect)(() => {
				...
				fetchPresets().then((ps) => {
					...
					setPreset((current) => {
						...
						return ps.find((p) => p.id === "standard" && p.broken === void 0)?.id ?? ps.find((p) => p.broken === void 0)?.id ?? "";
					});
				}).catch(() => void 0);
				return () => {
					stale = true;
			...
			(0, react.useEffect)(() => {
				...
				fetchProviders().then((ps) => {
					...
					if (!stale) setProvidersLoaded(true);
				});
				return () => {
					stale = true;
				};
			...
			(0, react.useEffect)(() => {
				...
				fetchModels(provider.trim()).then((ms) => {
					if (stale) return;
					setModels(ms);
					setModel((current) => {
			...
			(0, react.useEffect)(() => {
				if (scan.status === "waiting" && canvasRef.current !== null) (0, import_browser.toCanvas)(canvasRef.current, scan.url, { width: 200 }).catch(() => void 0);
			}, [scan]);
			/** 第一步放行条件：名称与绑定项目均非空。 */
			...
			async function beginScan() {
				...
				try {
					...
					pollTimer.current = setInterval(() => {
						pollRegisterApp(regId).then((state) => {
							if (state.status === "pending" && state.url !== void 0) setScan({
								status: "waiting",
								url: state.url
							});
								...
								setScan({
									status: "error",
									message: state.description ?? state.code
								});
							}
						}).catch(() => void 0);
					}, POLL_INTERVAL_MS);
			...
			(0, react.useEffect)(() => {
				if (step === 2 && !editing && scan.status === "idle") beginScan();
			}, [
				step,
				scan.status,
				editing
			...
			async function save() {
				setError(null);
				const feishu = editing ? void 0 : tab === "scan" ? scan.status === "done" ? {
					appId: scan.appId,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: bots_module_css_default.steps,
					"aria-label": "创建步骤",
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: clsx(bots_module_css_default.step, step === 1 && bots_module_css_default.stepActive),
							children: "1 基本信息"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: bots_module_css_default.stepSeparator,
							children: "·"
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: clsx(bots_module_css_default.step, step === 2 && bots_module_css_default.stepActive),
							children: "2 飞书渠道绑定"
						})
					]
				}),
				step === 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						...
						children: ["名称", /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Input, {
							value: name,
							onChange: (e) => {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						className: bots_module_css_default.field,
						children: ["绑定项目", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
							...
							"aria-label": "绑定项目",
							children: workspaces.map((w) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
								value: w.path,
								children: [
									w.title,
									"（",
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						className: bots_module_css_default.field,
						children: ["提示词", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
							className: bots_module_css_default.textarea,
							value: persona,
							onChange: (e) => {
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						className: bots_module_css_default.field,
						children: ["Preset", /* @__PURE__ */ (0, react_jsx_runtime.jsx)("select", {
							className: bots_module_css_default.select,
							value: preset,
							"aria-label": "Preset",
							...
							children: presets.map((p) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: p.id,
								disabled: p.broken !== void 0,
								children: p.name
							}, p.id))
						})]
					}),
				...
				step === 2 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					!editing && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							role: "tablist",
							className: bots_module_css_default.tabs,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								role: "tab",
								"aria-selected": tab === "scan",
								className: clsx(bots_module_css_default.tab, tab === "scan" && bots_module_css_default.tabActive),
								onClick: () => {
									setTab("scan");
								},
								children: "扫码一键创建"
								...
								className: clsx(bots_module_css_default.tab, tab === "manual" && bots_module_css_default.tabActive),
								onClick: () => {
									setTab("manual");
								},
								children: "手动填写"
							})]
						}), tab === "scan" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
							scan.status === "idle" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								variant: "outline",
								onClick: () => {
									beginScan();
								},
							...
							scan.status === "waiting" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							scan.status === "done" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
								"已创建应用：",
								scan.appId,
								"（密钥已安全保存）"
							] }),
							scan.status === "error" && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
								"扫码创建失败：",
								scan.message,
								" ",
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
		...
		//#endregion
		//#region src/client/BotsModal.tsx
		...
		function BotsModal({ open, onClose, useWorkspaces, onEdit, onCreate }) {
			...
			if (state.status === "ok") for (const bot of state.bots) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				...
				title: "消息机器人",
				closeLabel: "关闭",
				className: bots_module_css_default.dialog,
				children: view === "list" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					state.status === "ok" && state.bots.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: "还没有机器人，点击「新建机器人」开始。" }),
					state.status === "ok" && [...groups.entries()].map(([project, bots]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						className: bots_module_css_default.group,
				...
				] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BotForm, {
					useWorkspaces,
					bot: view.mode === "edit" ? view.bot : void 0,
					onSaved: () => {
						setReload((n) => n + 1);
						setView("list");
					},
		...
		//#endregion
		//#region src/client/BotsEntry.tsx
		/** 侧边栏底栏入口：宽栏图标+文字 / 窄栏仅图标；点击开机器人管理模态框。 */
		function BotsEntry({ wide, useWorkspaces }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
					className: clsx(bots_module_css_default.trigger, !wide && bots_module_css_default.rail),
					"aria-label": "消息机器人",
					onClick: () => {
						setOpen(true);
					},
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconAgentPresetOutline16, { size: wide ? 16 : 18 }), wide && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						className: bots_module_css_default.triggerLabel,
						children: "消息机器人"
					})]
				})
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BotsModal, {
				open,
				onClose: () => {
					setOpen(false);
				},
