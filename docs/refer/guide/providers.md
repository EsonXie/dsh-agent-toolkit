...
> 来源：<https://deepseek-harness.github.io/deepseek-harness/guide/providers>
...
![模型页：DeepSeek 卡片，以及添加提供方与添加自定义提供方两个入口](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/user/guide/providers-models-page.zh.png)
...
![自定义提供方表单：Provider ID、显示名称、API 地址、API 协议、API 密钥](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/user/guide/providers-custom-form.zh.png)
